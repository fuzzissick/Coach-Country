...
public class CoachSessionSummary extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private void setSessionSummary(String documentID){
        ...
        db.collection("runners").document(runnerID).collection("sessions").document(documentID).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
